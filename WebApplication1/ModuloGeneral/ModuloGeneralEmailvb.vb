...
Namespace ModuloGeneral
    ...
    Public Class ModuloGeneralEmail
        Public Function ConstructEmail(ByVal data As ConstructInfo) As Boolean
            ...
            Dim security As New Security.UserAD
            Dim email As New ModuloGeneralEmail
            Dim emailData As New MailData
            Dim strMessage As String = String.Empty

            mailInfo = emailData.EmailData_Get(data.EmailType)
            'mailInfo.mSendTo = Global.Security.UserAD.GetUserEmail(data.UserName)
            mailInfo.mMessage = mailInfo.mMessage.Replace("{ChangeNo}", data.ChangeNo)
            mailInfo.mMessage = mailInfo.mMessage.Replace("{link}", data.Link)
        ...
        Public Function GetHtmlBody(ByVal info As MailInfo) As String
            ...
            Dim strPath As String = HostingEnvironment.MapPath("~/ModuloGeneral/htmlMailTemplate.htm")
